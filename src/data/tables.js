...
// Injected into pages as a content script; the individual dictionaries are
// assembled into the global PARIVARTAN_TABLES at the end of this file.
...
// Exposed as a global within the content script's isolated world.
var PARIVARTAN_TABLES = {
    iso2itrans_dict:  iso2itrans_dict,
    iast2itrans_dict: iast2itrans_dict,
    devanagari_dict:  devanagari_dict,
    telugu_dict:      telugu_dict,
    kannada_dict:     kannada_dict,
    gujarati_dict:    gujarati_dict,
    tamil_dict:       tamil_dict,
    bengali_dict:     bengali_dict,
    gurmukhi_dict:    gurmukhi_dict,
    malayalam_dict:   malayalam_dict,
    oriya_dict:       oriya_dict,
    english_dict:     english_dict,
    katapayadi_dict:  katapayadi_dict
};
